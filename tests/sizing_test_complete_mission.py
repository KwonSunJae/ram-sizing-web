...
# ==========set input file ############### 
opt = adsp.SizingOptimization(input_filename='ram_demo_input_include_reserve_mission')
...
specific_energy_sweep = [650, 700, 800, 900, 1000, 1500]
payload_sweep = [0,  954, 1154]
